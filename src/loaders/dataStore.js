...
const products = [
  ...
  },
  {
    ...
    description: `Procesador de imagen DIGIC 8 Sensor CMOS (APS-C) de 24.1 megapíxeles ISO 100-25600 (H: 51200)  Vídeo 4K UHD de 24p y HD de 120p para cámara lenta
    Pantalla táctil LCD de ángulo variable  Conexión Wi-Fi y Bluetooth`,
    price: 104999,
    points: 0,
    subCategory: 'Reflex'
  },
  {
    ...
    description: `El Kit Nikon Z7 + 24-70mm f4 S es una combinación muy versatil aprovecha al máximo el sistema de estabilización de 5 ejes integrado en 
    el cuerpo con esta excelente lente.su sensor de 45,7 Mpx CMOS ha sido creado para maximizar la captura de luz y obtener una nitidez superior en todas t
    us fotografías.`,
    price: 689000,
    points: 0,
    subCategory: 'Reflex'
  },
  {
    ...
    description: `20.0 mpx Procesador digic 4+ (+rápido y +calidad) Zoom 42x (24-1008 mm) Pantalla 3.0” VIDEO 720p HD Af de alta velocidad Estabilizador de imagen
  ...
  },
  {
    ...
    description: `MOTOR PARA EL AF USM de anillo ÁNGULO DE VISIÓN 20°, 14°, 24° (horizontal, vertical, diagonal)
     AUMENTO CON TUBO DE EXTENSIÓN EF25 II 1,37-0,27  AUMENTO CON TUBO DE EXTENSIÓN EF12 II 1,17-0,12 MOTOR PARA EL AF, NOTA AL PIE AF Enfoque continuo manual
     ABERTURA MÍNIMA 32 CONSTRUCCIÓN DEL OBJETIVO (ELEMENTOS/GRUPOS) 15/12 INFORMACIÓN DE LA DISTANCIA Sí AMPLIACIÓN 1`,
    price: 294000,
    points: 0,
    subCategory: 'Zoom'
  },
  {
    ...
    description: `Este objetivo es compatible con las cámaras de la serie D3000 a partir de la D3300
     en adelante, con las cámaras de la serie D5000 a partir de la D5200 en adelante y con las cámaras 
  ...
  },
  {
    ...
    description: `Distancia Focal 50mm Formato FX/35mm Apertura máxima f/1.8 Dimensiones aproximadas 72.1mm x 52.4mm (diametro x longitud)
    Peso 185 grs Apertura mínima f/16 Angulo de visión máximo (Formato Fx) 47° Angulo de visión máximo (Formato Dx) 31.30°´`,
    price: '437.000,00',
    points: 6,
    subCategory: 'Fijo'
  },
  ...
  },
  {
    ...
    description: 'El visor réflex permite obtener una perspectiva realista y tomar fotografías increíbles con resultados más exactos gracias a la posibilidad de intercambiar objetivos. Además, por sus múltiples funcionalidades, podés dar rienda suelta a tu creatividad y controlar diferentes parámetros para tomar la fotografía perfecta.',
    price: 78127,
    points: 1,
    subCategory: 'Reflex'
  },
...

  {
    ...
    description: 'El visor réflex permite obtener una perspectiva realista y tomar fotografías increíbles con resultados más exactos gracias a la posibilidad de intercambiar objetivos. Además, por sus múltiples funcionalidades, podés dar rienda suelta a tu imaginación',
    price: 189000,
    points: 3,
